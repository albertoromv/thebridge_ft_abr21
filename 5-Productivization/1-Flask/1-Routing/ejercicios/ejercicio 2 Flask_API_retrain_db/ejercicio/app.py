...
# tenéis que conectaros con sqlite3 a advertising.db
# crear una tabla con los campos que aparecen en Advertising.csv
'''
La petición sería:
...
def createdb():
    ...
    with open("1-Flask/1-Routing/ejercicios/ejercicio 2 Flask_API_retrain_db/ejercicio/advertising.csv", "r") as fin:
        dr = csv.DictReader(fin) # la coma es el delimitador por defecto
...
@app.route("/api/v1/adv_model/register")
def new_register():
    args = request.args 
